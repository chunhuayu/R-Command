...
# In the last chapter you saw that all the visible aesthetics can serve as attributes and aesthetics, 
# but I very conveniently left out x and y. 
# That's because although you can make univariate plots (such as histograms, 
# which you'll get to in the next chapter), a y-axis will always be provided, even if you didn't ask for it.

# In the base package you can make univariate plots with stripchart()
# (shown in the viewer) directly and it will take care of a fake y axis for us. 
# Since this is univariate data, there is no real y axis.

# You can get the same thing in ggplot2, but it's a bit more cumbersome. 
