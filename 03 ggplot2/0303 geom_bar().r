...
# You saw how jittering worked in the video, but bar plots suffer from their own issues of overplotting, as you'll see here. 
# Use the "stack", "fill" and "dodge" positions to reproduce the plot in the viewer.

# The ggplot2 base layers (data and aesthetics) have already been coded; they're stored in a variable cyl.am. 
# It looks like this:
...
# The position = "dodge" version seems most appropriate. 
...
# scale_fill_manual() fixes the legend. The first argument is the title of the legend: "Transmission".
