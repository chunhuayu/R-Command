...
# In the previous chapter you saw that there are lots of ways to position scatter plots. 
# Likewise, the geom_bar() and geom_histogram() geoms also have a position argument,
# which you can use to specify how to draw the bars of the plot.
...
# In this exercise you'll draw the total count of cars having a given number of cylinders (cyl), 
