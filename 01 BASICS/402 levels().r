...
# but it can introduce confusion when analyzing the data. 
...
### .......... To correctly map "F" to "Female" , "M" to "Male", the levels should be set to c("Female", "Male").
...
> levels(factor_survey_vector) <- survey_vector
> 
