...
# you can use the assignment operator to give the function a name. It's perfectly possible, 
# however, to not give the function a name. This is called an anonymous function:
