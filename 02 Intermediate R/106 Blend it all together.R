...
# You stored the results in a data frame called li_df. 
# This data frame is available in the workspace; type li_df in the console to check it out.

### INSTRUCTIONS
# 1. Select the entire second column, named day2, from the li_df data frame as a vector and assign it to second.
# 2. create a logical vector, that contains TRUE if the corresponding number of views is strictly greater than 25 
# or strictly lower than 5 and FALSE otherwise. Store this logical vector as extremes.
# 3. Use sum() on the extremes vector to calculate the number of TRUEs in extremes 
